...
class MassAttackComponent extends Component {
  ...
  componentDidMount() {
    ...
    preload: function ()
    {
      ...
      let ball = this.load.image('ball', 'assets/rsz_redBall.png');
      this.load.image('balance', 'assets/balance.png');
      // this.load.spritesheet('ball', 'assets/metalface78x92.png', {
        // frameWidth: 78,
        // frameHeight: 92
      // });
    },
...
export default MassAttackComponent;
